...
export namespace Convert {
  export function toSearchResponse(json: string): SearchResponse {
    return cast(JSON.parse(json), r("SearchResponse"));
  }

  export function searchResponseToJson(value: SearchResponse): string {
  ...
  const typeMap: any = {
    ...
    "Datum": o([
      ...
      { json: "import_datetime", js: "import_datetime", typ: "" },
    ...
    "Images": o([
      { json: "original", js: "original", typ: m("") },
      ...
      { json: "fixed_height", js: "fixed_height", typ: m("") },
      { json: "fixed_height_downsampled", js: "fixed_height_downsampled", typ: m("") },
      { json: "fixed_height_small", js: "fixed_height_small", typ: m("") },
      ...
      { json: "fixed_width", js: "fixed_width", typ: m("") },
      { json: "fixed_width_downsampled", js: "fixed_width_downsampled", typ: m("") },
      { json: "fixed_width_small", js: "fixed_width_small", typ: m("") },
